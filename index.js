 ...
 * @returns {number|string|undefined} Повертає - foundElement - перший елемент масиву, який є більшим за задане число
 */
function findElementGreaterThan(arr, num) {
  ...
  if (foundElement !== undefined){
    ...
    return "Числа яке задовільняє умову не знайдено";
  }
 ...
 * @param {*} name - ім'я, яке використовується для порівняння з властивістю 'name' об'єктів масиву.
 * @returns {index} Повертає - foundIndex - індекс першого об'єкта, властивість 'name' якого співпадає з заданим іменем.
 ...
 *  @param {index} startIdx - індекс з якого починається підмасив.
 * @returns {} Повертає - subArrayString - рядок, отриманий в результаті конвертації підмасиву.
 */
...
//  const dublicateElements = Object.keys(elementCounts)
